...
export default function DirectChat() {
  ...
  const { uid: friendUid } = router.query;
              ...
              {messages.map((msg, i) => (
                <div
                  ...
                  className={`flex w-full ${
                    msg.sender == friendUid ? "justify-start " : "justify-end "
                  }`}
                >
                  <div
                    className={`flex flex-col w-fit rounded-lg min-w-[150px] ${
                      msg.sender == friendUid ? "bg-blue-500" : "bg-primary-500"
                    } px-4 py-2`}
                  >
